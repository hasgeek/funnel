...
def upgrade():
    ...
    op.add_column('proposal', sa.Column('blog_post', sa.Text(), server_default=u'', nullable=False))
    op.alter_column('proposal', 'blog_post', server_default=None)
    op.add_column('proposal', sa.Column('preview_video', sa.Text(), server_default=u'', nullable=False))
