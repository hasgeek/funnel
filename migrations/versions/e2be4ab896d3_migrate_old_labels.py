                ...
                .values(
                    {
                        ...
                        'name': st_name,
                        'title': st_title,
                        'main_label_id': sessiontype_label,
                        'seq': index,
                        'description': "",
                        'restricted': False,
                        'archived': False,
