...
def downgrade():
    op.add_column('project', sa.Column('bg_color', sa.VARCHAR(length=6), autoincrement=False, nullable=True))
    op.add_column('project', sa.Column('explore_url', sa.TEXT(), autoincrement=False, nullable=True))
