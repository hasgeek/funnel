...
def death_membership(db_session, org_ankhmorpork, user_death):
    membership = models.OrganizationMembership(
        organization=org_ankhmorpork, member=user_death
    )
...
def death_owner_membership(db_session, org_ankhmorpork, user_death):
    membership = models.OrganizationMembership(
        organization=org_ankhmorpork, member=user_death, is_owner=True
    )
    db_session.add(membership)
    db_session.commit()
    return membership
...
def rincewind_membership(db_session, org_ankhmorpork, user_rincewind):
    membership = models.OrganizationMembership(
        organization=org_ankhmorpork, member=user_rincewind
    )
    db_session.add(membership)
    db_session.commit()
    return membership
...
def rincewind_owner_membership(db_session, org_ankhmorpork, user_rincewind):
    membership = models.OrganizationMembership(
        organization=org_ankhmorpork, member=user_rincewind, is_owner=True
    )
    db_session.add(membership)
    db_session.commit()
    return membership
...
def test_merge_multiple_memberships(
    ...
    uu_death_owner_membership = models.OrganizationMembership(
        organization=org_uu, member=user_death, is_owner=True
    )
    db_session.add(uu_death_owner_membership)
    db_session.commit()
    uu_rincewind_membership = models.OrganizationMembership(
        organization=org_uu, member=user_rincewind, is_owner=False
    )
