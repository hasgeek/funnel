...
def test_usersession_revoke(models, utcnow, user_twoflower) -> None:
...
def test_usersession_get(models, buid, utcnow, user_twoflower) -> None:
...
def test_usersession_active_sessions(models, buid, utcnow, user_twoflower) -> None:
...
def test_usersession_authenticate(models, utcnow, db_session, user_dibbler) -> None:
...
def test_usersession_authenticate_suspended_user(
    models, utcnow, db_session, user_dibbler
) -> None:
