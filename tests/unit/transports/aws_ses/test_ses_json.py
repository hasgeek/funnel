...
class TestSesEventJson:
    ...
    def test_delivery(self) -> None:
        ...
        with open(
            os.path.join(self.data_dir, "delivery.json"), encoding='utf-8'
        ) as file:
            data = file.read()
    ...
    def test_delivery_without_subject(self) -> None:
        ...
        with open(
            os.path.join(self.data_dir, "delivery-without-subject.json"),
            encoding='utf-8',
        ) as file:
            data = file.read()
        obj: SesEvent = SesEvent.from_json(data)
    ...
    def test_bounce(self) -> None:
        ...
        with open(os.path.join(self.data_dir, "bounce.json"), encoding='utf-8') as file:
            data = file.read()
        obj: SesEvent = SesEvent.from_json(data)
        assert obj.bounce
    ...
    def test_complaint(self) -> None:
        ...
        with open(
            os.path.join(self.data_dir, "complaint.json"), encoding='utf-8'
        ) as file:
            data = file.read()
        obj: SesEvent = SesEvent.from_json(data)
    ...
    def fixme_test_signature_good_message(self) -> None:
        ...
        with open(
            os.path.join(self.data_dir, "full-message.json"), encoding='utf-8'
        ) as file:
            data = file.read()
    ...
    def fixme_test_signature_bad_message(self) -> None:
        """Check if Signature Verification works."""
        with open(
            os.path.join(self.data_dir, "bad-message.json"), encoding='utf-8'
        ) as file:
            data = file.read()
