...
def init_models():
    with app.test_request_context():
        ...
        owner_email = AccountEmail(email='profileowner@example.com', account=owner)
        ...
        org1 = Organization(name='fifthelephant', title='Fifth elephant', owner=owner)
        ...
        admin_email = AccountEmail(email='adminuser@example.com', account=admin)
        db.session.add(admin.add_phone('+918123456789', primary=True))
        org2 = Organization(name='rootconf', title='Rootconf', owner=admin)
        ...
        org3 = Organization(name='jsfoo', title='JSFoo', owner=editor)
        org3.is_verified = True
        org3.make_profile_public()

        project3 = Project(
            name='monsoon-edition',
            title='Monsoon Edition',
            created_by=editor,
            account=org3,
            location='Online',
            tagline='Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ...
        org4 = Organization(name='metarefresh', title='Metarefresh', owner=promoter)
        ...
        org5 = Organization(name='kilter', title='Kilter', owner=usher)
        ...
        sm = SiteMembership(member=owner, is_site_editor=True, granted_by=owner)
        ...
        venue1 = Venue(
            name='hasgeek',
            title='Hasgeek House',
            description='Hasgeek House second floor',
            project=project4,
            seq=1,
        )
        venue2 = Venue(
            name='online', title='Online', description='Zoom', project=project4, seq=2
        )
        room1 = VenueRoom(
