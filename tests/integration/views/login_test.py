...
def test_user_rincewind_has_username(user_rincewind: models.User) -> None:
    """Confirm user fixture has the username required for further tests."""
    assert user_rincewind.username == RINCEWIND_USERNAME


def test_user_register_otp_sms(client: TestClient, csrf_token: str) -> None:
...
def test_user_register_otp_email(client: TestClient, csrf_token: str) -> None:
...
def test_user_register_otp_email_malformed(client: TestClient, csrf_token: str) -> None:
...
def test_user_register_otp_email_invalid(client: TestClient, csrf_token: str) -> None:
...
def test_login_usernames(
    ...
    csrf_token: str,
    login_username: str,
    password_status_auth: SimpleNamespace,
) -> None:
...
def test_invalid_otp_login(
    client: TestClient, csrf_token: str, login_username: str
) -> None:
...
def test_user_password_sudo_prompt(
    client: TestClient,
    login: LoginFixtureProtocol,
    user_rincewind_with_password: models.User,
) -> None:
...
def test_weak_password(client: TestClient, csrf_token: str) -> None:
...
def test_expired_password(
    client: TestClient, csrf_token: str, user_rincewind_with_password: models.User
) -> None:
...
@pytest.mark.usefixtures('user_rincewind_email')
def test_login_password_exception(client: TestClient, csrf_token: str) -> None:
...
@pytest.mark.usefixtures('user_rincewind_phone')
def test_sms_otp_not_sent(client: TestClient, csrf_token: str) -> None:
...
@pytest.mark.usefixtures('user_rincewind_phone')
def test_otp_timeout_error(client: TestClient, csrf_token: str) -> None:
...
@pytest.mark.usefixtures('user_rincewind_phone')
def test_otp_reason_error(client: TestClient, csrf_token: str) -> None:
...
def test_login_external(client: TestClient) -> None:
...
def test_service_not_in_registry(client: TestClient) -> None:
...
def test_phone_otp_not_supported(
    client: TestClient, csrf_token: str, phone_number: str, message_fragment: str
) -> None:
...
@pytest.mark.usefixtures('user_rincewind_email')
def test_incomplete_form(client: TestClient, csrf_token: str) -> None:
...
def test_render_login_form(client: TestClient) -> None:
...
def test_logout_redirect_index(client: TestClient) -> None:
...
def test_account_logout_csrf_validation_json(
    client: TestClient, login: LoginFixtureProtocol, user_rincewind: models.User
) -> None:
...
def test_account_logout_csrf_validation_html(
    client: TestClient, login: LoginFixtureProtocol, user_rincewind: models.User
) -> None:
...
def test_login_service_init_error(client: TestClient) -> None:
...
def test_login_service_callback_error(client: TestClient) -> None:
...
def test_merge_buid_not_in_session(
    client: TestClient, login: LoginFixtureProtocol, user_twoflower: models.User
) -> None:
