...
ticket_list = [{
    ...
    'phone': u'123',
    'twitter': format_twitter_handle(u'@p{id}'.format(id=unicode(1))),
    ...
    'phone': u'123',
    'twitter': format_twitter_handle(u'@p{id}'.format(id=unicode(2))),
    'job_title': u'Engineer',
    'company': u'Acme',
    'city': u'Atlantis',
    ...
    'phone': u'123',
    'twitter': format_twitter_handle(u'@p{id}'.format(id=unicode(3))),
    'job_title': u'Engineer',
    'company': u'Acme',
    'city': u'Atlantis',
