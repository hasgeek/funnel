...
SITE_TITLE = 'Hasgeek'
SQLALCHEMY_DATABASE_URI = f'postgresql+psycopg://{environ.get("POSTGRES_USER_HOST", "localhost")}:5432/funnel_testing'
SQLALCHEMY_BINDS = {
    'geoname': f'postgresql+psycopg://{environ.get("POSTGRES_USER_HOST", "localhost")}:5432/geoname_testing',
}
