...
class PROFILE_STATE(LabeledEnum):  # noqa: N801
    """The visibility state of a profile (auto/public/private)."""
...
class Profile(UuidMixin, BaseMixin, db.Model):
    ...
    def owner(self) -> Union[User, Organization]:
        """Return the user or organization that owns this profile."""
    ...
    @state.transition(
        ...
        if_=lambda profile: (
            ...
            and (profile.user is None or profile.user.features.allowed_creator)
        ),
    )
