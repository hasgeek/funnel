...
from coaster.utils import LabeledEnum, NameTitle, newsecret, require_one_of, utcnow
...
class PROFILE_STATE(LabeledEnum):  # noqa: N801
    ...
    AUTO = (1, NameTitle('auto', __("Autogenerated")))
    PUBLIC = (2, NameTitle('public', __("Public")))
    PRIVATE = (3, NameTitle('private', __("Private")))
