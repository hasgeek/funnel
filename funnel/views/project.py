...
def project_data(project):
    return {
        ...
        'start': project.schedule_start_at.date().isoformat() if project.schedule_start_at else None,
        'end': project.schedule_end_at.date().isoformat() if project.schedule_end_at else None,
