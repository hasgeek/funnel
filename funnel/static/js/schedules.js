                ...
                if (this.editable) {
                    ...
                    this.color_form.submit(function() {
                        ...
                        $('input[name="uuid"]').each(function(index, element) {
                            ...
                            json[venue] = {
                                seq: $(
                                    'input[name="venue-seq"][data-venue="' +
                                        venue +
                                        '"]'
                                ).val(),
                                rooms: []
            ...
            config.drop = function(date, allDay) {
                ...
                event.end.setMinutes(
                    event.end.getMinutes() +
                        calendar.options.config.defaultEventMinutes
                );
            ...
            if (settings.editable) {
                buttons.save = (function() {
                    calendar.container
                        ...
                        .append(
                            '<span class="hg-fc-button save-schedule">Save</span>'
                        );
