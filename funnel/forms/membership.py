...
class ProjectCrewMembershipForm(forms.Form):
    ...
    is_editor = forms.BooleanField(__("Editor"), default=False, description=__("Can edit project details, proposal guidelines, schedule, label and venue "))
    is_concierge = forms.BooleanField(__("Concierge"), default=False, description=__("Can setup events for check-in, add ticket clients and attendees"))
    is_usher = forms.BooleanField(__("Usher"), default=False, description=__("Can check-in attendees"))
