...
class ProjectCrewMembershipForm(forms.Form):
    ...
    is_editor = forms.BooleanField(__("Editor"), default=False, description=__("Can edit project details, proposal guidelines, schedule, labels and venues"))
    is_concierge = forms.BooleanField(__("Concierge"), default=False, description=__("Can manage participants and see contact info"))
    is_usher = forms.BooleanField(__("Usher"), default=False, description=__("Can check-in a participant using their badge at a physical event"))
