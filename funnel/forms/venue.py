...
class VenueForm(Form):
    ...
    address1 = wtforms.TextField(__("Address (line 1)"),
        validators=[wtforms.validators.Required(), wtforms.validators.length(max=160)])
    ...
    city = wtforms.TextField(__("City"),
        validators=[wtforms.validators.Required(), wtforms.validators.length(max=30)])
    ...
    country = wtforms.SelectField(__("Country"),
        validators=[wtforms.validators.Required(), wtforms.validators.length(max=2)],
